...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#container01', { style: 'fade-in', speed: 1000, intensity: 5, delay: 250, replay: false });
		onvisible.add('#container01 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, delay: 625, replay: false });
		onvisible.add('#image01', { style: 'fade-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#text01', { style: 'fade-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#text02', { style: 'fade-in', speed: 1000, intensity: 5, delay: 1375, replay: false });
		onvisible.add('#buttons01', { style: 'fade-in', speed: 1000, intensity: 5, delay: 1500, stagger: 375, replay: false });
